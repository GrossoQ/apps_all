...
async def telnet_to_olt(olt, puerto, posicion): # OLT Inicial
    ...
    elif olt == "321" or olt == "322" or olt == "323" or olt == "521" or olt == "221":
...
connect_button1 = tk.Button(root, text="Migrar", command=lambda: asyncio.run(on_connect()), bg="gray", fg="white", font=("Arial", 12), padx=10, pady=5, relief="solid", borderwidth=1)
connect_button1.grid(row=1, column=0, columnspan=2, padx=(10,5), pady=10)

connect_button2 = tk.Button(root, text="Datos OLT1", command=lambda: asyncio.run(ver_datos()), bg="gray", fg="white", font=("Arial", 12), padx=10, pady=5, relief="solid", borderwidth=1)
connect_button2.grid(row=1, column=0, padx=5, pady=10)

connect_button3 = tk.Button(root, text="Datos OLT2", command=lambda: asyncio.run(ver_datos2()), bg="gray", fg="white", font=("Arial", 12), padx=10, pady=5, relief="solid", borderwidth=1)
